...
statepharmacy <- statepharmacy %>% 
  ...
  select(State, Population, totalpharmacies, ratio) %>% 
...
ggplot() +
  geom_sf(data = states, aes(fill = ratio)) + labs(x = "Longitude", y = "Latitude", title = "Ratio of Potential Pharmacies for COVID Testing \n to Population Density per State") 
```
